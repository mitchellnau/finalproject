...
resArrayDoExpressCheckout = ConfirmPayment ( str(finalPaymentAmount),form.getvalue('PayerID'),token )
...
if ackDoExpressCheckout == "SUCCESS" or ackDoExpressCheckout == "SUCCESSWITHWARNING":
	...
	transactionId = resArrayDoExpressCheckout["PAYMENTINFO_0_TRANSACTIONID"][0]

	#' The type of transaction Possible values: l  cart l  express-checkout
	transactionType = resArrayDoExpressCheckout["PAYMENTINFO_0_TRANSACTIONTYPE"][0]

	#' Indicates whether the payment is instant or delayed. Possible values: l  none l  echeck l  instant
	paymentType	= resArrayDoExpressCheckout["PAYMENTINFO_0_PAYMENTTYPE"][0]

	#' Time/date stamp of payment
	orderTime = resArrayDoExpressCheckout["PAYMENTINFO_0_ORDERTIME"][0]

	#' The final amount charged, including any shipping and taxes from your Merchant Profile.
	amt	= resArrayDoExpressCheckout["PAYMENTINFO_0_AMT"][0]
	...
	currencyCode = resArrayDoExpressCheckout["PAYMENTINFO_0_CURRENCYCODE"][0]
	...
	*/'''
	...
	htmlcode ="""\
		...
		<span class="span5">
			...
			<h4> {firstName} {lastName}, Thank you for your Order </h4>
