...
if USERACTION_FLAG == 'True':
        returnURL = 'http://'+socket.gethostbyname(socket.gethostname())+ '/cgi-bin/Checkout/lightboxreturn.py' 
else:
        returnURL = 'http://'+socket.gethostbyname(socket.gethostname())+ '/cgi-bin/Checkout/lightboxreturn.py'
...
if not form.getvalue("Confirm") and form.getvalue("checkout"):
	...
	<div class="span4">
   	...
   	<div class="span5">
			...
			<input type="hidden" name="EXPRESS_MARK" value="ECMark"></input>
					...
					<tr><td colspan="2"><input id="p_method_paypal_express" value="paypal_express" type="radio" name="payment[method]" title="PayPal Express Checkout" class="radio" disabled>&nbsp;Credit Card</td></tr>
					<tr><td>&nbsp;</td></tr>
	...
	print """\
   	...
   	<script src="//www.paypalobjects.com/api/checkout.js" async></script>""" % (merchantId, environment)
else:
