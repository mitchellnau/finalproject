	 ...
	 <h3> DIGITAL SLR CAMERA </h3>
          <table>
            ...
            <form class="form" action="paypal_ec_redirect.py" method="POST">
                        ...
                        <tr><img src="http://%s/img/camera.jpg" width="160" height="100"/></tr>
				...
				<option value="TRY">TRY</option>
                        ...
                        <tr><td colspan="2" align="right"><input type="image" src="https://www.paypalobjects.com/webstatic/en_US/i/buttons/ppcredit-logo-medium.png" alt="PayPal Credit"/></td></tr>
            </form>
	</table>
      </div>
      <div class="span6">
         <h4> README: </h4>
		  ...
		  1)Click on 'PayPal Credit' button and see the experience.	
                  ...
                  <br>
                  4) The sample code uses default sandbox credentials which are set in config.ini. You can create your own credentials by creating PayPal Seller and Buyer accounts on Sandbox  <i><a href="https://developer.paypal.com/webapps/developer/applications/accounts/create" target="_blank">here</a></i>.
                  <br>
                  5) Make following changes in config.ini:<br>
               ...
               <br><br>            
               <pre><code>&lt;form action="paypal_ec_redirect.py" method="POST"&gt;
